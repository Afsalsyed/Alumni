    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_status', models.CharField(choices=[('Emp', 'Employee'), ('Entrepreneur', 'Entrepreneur'), ('Unemp', 'Unemployed'), ('Home maker', 'Home maker / House wife')], default='Emp', max_length=12)),
